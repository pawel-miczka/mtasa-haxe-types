...
Note: This function does not stop the resource immediately, so don't expect that it starts stopping until the onResourceStop event for that resource is triggered. This happens after the scripts are done executing for this server frame.
	...
	**/
	static function executeSQLQuery(query:String, params:Rest<Dynamic>):Array<Dynamic>;
	...
	**/
	static function dbExec(databaseConnection:DatabaseConnection, query:String, params:Rest<Dynamic>):Bool;
	...
	**/
	static function dbPoll(queryHandle:QueryHandle, timeout:Int, ?multipleResults:Bool = false):Array<Dynamic>;
	...
	**/
	static function dbPrepareString(databaseConnection:DatabaseConnection, query:String, params:Rest<Dynamic>):String;
	...
	**/
	static function dbQuery(databaseConnection:DatabaseConnection, query:String, params:Rest<Dynamic>):QueryHandle;
